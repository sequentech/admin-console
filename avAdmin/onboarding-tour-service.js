    ...
    function($i18next, $window)
    {
        return function (el)
        {
            ...
            var helpTour = {
                ...
                steps: [
                    {
                        title: $i18next.t("avAdmin.onboarding.help_tour.step0_help_title"),
                        content: $i18next.t("avAdmin.onboarding.help_tour.step0_help_content"),
                        target: "#navbar-collapse-1 .help-dropdown a",
                        highlightTarget: "#navbar-collapse-1 .help-dropdown a",
                        placement: "bottom"
                    },
                    {
                        title: $i18next.t("avAdmin.onboarding.help_tour.step1_chat_title"),
                        content: $i18next.t("avAdmin.onboarding.help_tour.step1_chat_content"),
                        target: ".zsiq_cnt",
            ...
            var dashboardTour = {
                ...
                steps: [
                    {
                        title: $i18next.t("avAdmin.onboarding.dashboard_tour.step2_status_title"),
                        content: $i18next.t("avAdmin.onboarding.dashboard_tour.step2_status_content"),
                        target: ".statusbar.row.text-center",
                        highlightTarget: ".statusbar.row.text-center",
                        placement: "bottom"
                    },
                    {
                        title: $i18next.t("avAdmin.onboarding.dashboard_tour.step3_start_title"),
                        content: $i18next.t("avAdmin.onboarding.dashboard_tour.step3_start_content"),
            ...
            var tour = {
                ...
                steps: [
                    {
                        title: $i18next.t("avAdmin.onboarding.hello_tour.step0_create_title"),
                        content: $i18next.t("avAdmin.onboarding.hello_tour.step0_create_content"),
                    ...
                    {
                        title: $i18next.t("avAdmin.onboarding.hello_tour.step1_change_title"),
                        content: $i18next.t("avAdmin.onboarding.hello_tour.step1_change_content"),
                    ...
                    {
                        title: $i18next.t("avAdmin.onboarding.hello_tour.step2_sidebar_title"),
                        content: $i18next.t("avAdmin.onboarding.hello_tour.step2_sidebar_content"),
                        target: "ul[ng-if='current']",
                        highlightTarget: "ul[ng-if='current']",
                        placement: "right"
                    },
                    {
                        title: $i18next.t("avAdmin.onboarding.hello_tour.step3_review_title"),
                        content: $i18next.t("avAdmin.onboarding.hello_tour.step3_review_content"),
                    ...
                    {
                        title: $i18next.t("avAdmin.onboarding.hello_tour.step4_create2_title"),
                        content: $i18next.t("avAdmin.onboarding.hello_tour.step4_create2_content"),
