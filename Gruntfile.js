      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v103111.3.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v103111.3.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v103111.3.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v103111.3.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/avConfig-v103111.3.js"></script>'},
            {selector:'body',html:'<script src="/admin/avThemes-v103111.3.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v103111.3.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/avPlugins-v103111.3.js"></script>'},
