      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v10.4.0.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v10.4.0.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v10.4.0.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v10.4.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentConfig-v10.4.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentThemes-v10.4.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v10.4.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentPlugins-v10.4.0.js"></script>'},
