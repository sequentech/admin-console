      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/admin/avConfig-vmaster.js"></script>'},
            {selector:'body',html:'<script src="/admin/avThemes-vmaster.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-vmaster.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/avPlugins-vmaster.js"></script>'},
