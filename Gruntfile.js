      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v6.1.6.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v6.1.6.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v6.1.6.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v6.1.6.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentConfig-v6.1.6.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentThemes-v6.1.6.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v6.1.6.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentPlugins-v6.1.6.js"></script>'},
    ...
    uglify: {
      main: {
        ...
        files: {
          ...
          'dist/libcompat-v6.1.6.min.js': 'temp/libcompat.js',
