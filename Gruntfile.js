      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v5.0.8.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v5.0.8.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v5.0.8.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v5.0.8.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/avConfig-v5.0.8.js"></script>'},
            {selector:'body',html:'<script src="/admin/avThemes-v5.0.8.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v5.0.8.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/avPlugins-v5.0.8.js"></script>'},
    ...
    uglify: {
      main: {
        ...
        files: {
          ...
          'dist/libcompat-v5.0.8.min.js': 'temp/libcompat.js',
