      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v8.0.1.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v8.0.1.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v8.0.1.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v8.0.1.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentConfig-v8.0.1.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentThemes-v8.0.1.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v8.0.1.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentPlugins-v8.0.1.js"></script>'},
    ...
    uglify: {
      main: {
        ...
        files: {
          ...
          'dist/libcompat-v8.0.1.min.js': 'temp/libcompat.js',
