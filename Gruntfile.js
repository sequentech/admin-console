      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v4.0.0.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v4.0.0.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v4.0.0.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v4.0.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/avConfig-v4.0.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/avThemes-v4.0.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v4.0.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/avPlugins-v4.0.0.js"></script>'},
    ...
    uglify: {
      main: {
        ...
        files: {
          ...
          'dist/libcompat-v4.0.0.min.js': 'temp/libcompat.js',
