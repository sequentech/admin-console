      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v7.4.0.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v7.4.0.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v7.4.0.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v7.4.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentConfig-v7.4.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentThemes-v7.4.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v7.4.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentPlugins-v7.4.0.js"></script>'},
    ...
    uglify: {
      main: {
        ...
        files: {
          ...
          'dist/libcompat-v7.4.0.min.js': 'temp/libcompat.js',
