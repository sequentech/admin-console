      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v9.1.0.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v9.1.0.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v9.1.0.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v9.1.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentConfig-v9.1.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentThemes-v9.1.0.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v9.1.0.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentPlugins-v9.1.0.js"></script>'},
    ...
    uglify: {
      main: {
        ...
        files: {
          ...
          'dist/libcompat-v9.1.0.min.js': 'temp/libcompat.js',
