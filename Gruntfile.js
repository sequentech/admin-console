      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/admin/libcompat-v10.5.1.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/admin/libnocompat-v10.5.1.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/admin/libnocompat-v10.5.1.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/admin/lib-v10.5.1.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentConfig-v10.5.1.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentThemes-v10.5.1.js"></script>'},
            {selector:'body',html:'<script src="/admin/app-v10.5.1.min.js"></script>'},
            {selector:'body',html:'<script src="/admin/SequentPlugins-v10.5.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentPlugins-v10.5.1.js': [
    ...
    uglify: {
      main: {
        ...
        files: {
          ...
          'dist/libcompat-v10.5.1.min.js': 'temp/libcompat.js',
